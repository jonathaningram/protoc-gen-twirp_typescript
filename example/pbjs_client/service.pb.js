    ...
    twirp.example = (function() {
      ...
      example.Hat = (function() {
        ...
        Hat.fromObject = function fromObject(object) {
          if (object instanceof $root.twitch.twirp.example.Hat) return object;
      ...
      example.Size = (function() {
        ...
        Size.fromObject = function fromObject(object) {
          if (object instanceof $root.twitch.twirp.example.Size) return object;
          var message = new $root.twitch.twirp.example.Size();
          if (object.inches != null) message.inches = object.inches | 0;
          return message;
        };
